...
<section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>SISTEM INFORMASI OPTIMASI JALAN </h1>
      <h1>MELALUI SISTEM INFORMASI GEOGRAFIS BERBASIS WEB</h1>
      <h2>Di Cianjur</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>Desa Walahir</h2>
            <h3>Sistem informasi ini merupakan aplikasi optimasi kerusakan jlan di desa walahir.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Dalam sistem ini user dapat mencari informasi mengenai jalan yang ada di desa walahir dan dapat mengirimkan sebuah keluhan tentng kerusakan jallan agar staff desa walahir mampu melihat langsung jalan yang di keluhkan
            </p>
          </div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
          <div class="text-center" data-aos="zoom-in">
            <h2 style="font-weight: bold; text-transform: uppercase;">TIM KAMI</h2>
            <p>Pejabat Desa Walahir</p>
          </div>
